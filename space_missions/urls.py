...
urlpatterns = [
    ...
    path('organisations-metadata/', views.OrganisationMetadata.as_view(), name='organisations'),
    path('organisations/', views.OrganisationList.as_view(), name='organisations-list'),
